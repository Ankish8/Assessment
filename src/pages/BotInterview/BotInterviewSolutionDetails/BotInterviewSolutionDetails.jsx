...
import styles from './BotInterviewSolutionDetails.module.css';
import '../../../styles/utilities.css';

const BotInterviewSolutionDetails = () => {
  const navigate = useNavigate();

  const handleSaveAndContinue = () => {
    // Navigate back to home or complete the flow
    navigate('/');
  };

  const handlePrevious = () => {
    navigate('/bot-interview/evaluation-parameters');
  };
      ...
      <div className={styles.compactProgress}>
        <div>
          ...
          <div className={`${styles.progressStep} ${styles.lastStep}`}>
            <div className={`${styles.stepIndicator} ${styles.current}`}>5</div>
...
export default BotInterviewSolutionDetails;