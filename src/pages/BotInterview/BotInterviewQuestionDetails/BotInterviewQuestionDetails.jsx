...
import styles from './BotInterviewQuestionDetails.module.css';
import '../../../styles/utilities.css';

const BotInterviewQuestionDetails = () => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.compactProgress}>
        <div>
          ...
          <div className={styles.progressStep}>
            <div className={`${styles.stepIndicator} ${styles.current}`}>3</div>
...
export default BotInterviewQuestionDetails;