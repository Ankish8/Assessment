...
export declare const ButtonWrapper: ({ tooltipContent, tooltipPosition, tooltipHideDelay, tooltipShowDelay, tooltipContainerSelector, tooltipMoveBy, fullWidth, className, ...otherProps }: ButtonWrapperProps) => React.JSX.Element;
