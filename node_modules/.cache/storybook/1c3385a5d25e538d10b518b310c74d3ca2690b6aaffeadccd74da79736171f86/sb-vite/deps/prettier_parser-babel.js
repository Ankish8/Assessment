    ...
    (function(f) {
      ...
      var Ci = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Ue = (a, t) => {
        ...
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of Ai(t))
            !Ei.call(a, i) && i !== e && be(a, i, { get: () => t[i], enumerable: !(s = bi(t, i)) || s.enumerable });
        return a;
      };
        ...
        var Ui = (a) => class extends a {
          ...
          finishCallExpression(e, s) {
            ...
            if (i.callee.type === "Import") {
              ...
              i.type === "OptionalCallExpression" ? this.castNodeTo(i, "CallExpression") : i.optional = false;
            return i;
          }
        ...
        var ur = /\*?\s*@((?:no)?flow)\b/, fr = (a) => class extends a {
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), h = 9, c = true) : (this.expect(5), h = 8, c = false), l.exact = c; !this.match(h); ) {
              ...
              if (this.eat(0))
                x != null && this.unexpected(x), this.eat(0) ? (S && this.unexpected(S.loc.start), l.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, d))) : l.indexers.push(this.flowParseObjectTypeIndexer(N, d, S));
              else if (this.match(10) || this.match(47))
                x != null && this.unexpected(x), S && this.unexpected(S.loc.start), l.callProperties.push(this.flowParseObjectTypeCallProperty(N, d));
              else {
                let I = "init";
          ...
          parseImportSpecifier(e, s, i, r, n) {
            ...
            if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
              ...
              if (l !== null && M(this.state.type))
                e.imported = this.parseIdentifier(true), e.importKind = l;
              else {
                if (s)
            ...
            if ((i = n) != null && i.error || this.match(47)) {
              ...
              if (c.node && this.maybeUnwrapTypeCastExpression(c.node).type === "ArrowFunctionExpression") {
                if (!c.error && !c.aborted)
                  return c.node.async && this.raise(g.UnexpectedTypeParameterBeforeAsyncArrowFunction, h), c.node;
                u = c.node;
              }
              if ((o = n) != null && o.node)
            ...
            switch (e.hasUnknownMembers = l, n) {
              ...
              default: {
                ...
                if (!u && !f && c >= d) {
                  ...
                  return this.raise(g.EnumInconsistentMemberValues, r, { enumName: i }), h();
              }
            }
          }
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          jsxParseElementAt(e) {
            ...
            if (q(r) ? (s.openingFragment = r, s.closingFragment = n) : (s.openingElement = r, s.closingElement = n), s.children = i, this.match(47))
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 143)
              ...
              this.state.canStartJSXElement = qi(i);
          }
        }, Je = class extends me {
          constructor(...t) {
        ...
        var Qe = class extends Ye {
          ...
          finalizeComment(t) {
            ...
            if (t.leadingNode !== null || t.trailingNode !== null)
              t.leadingNode !== null && Ls(t.leadingNode, s), t.trailingNode !== null && xr(t.trailingNode, s);
            else {
        ...
        function xs(a, t, e, s, i, r) {
          ...
          for (; ; ) {
            ...
            if (d === 92) {
              ...
              d === 8232 || d === 8233 ? (++e, ++i, s = e) : d === 10 || d === 13 ? a === "template" ? (h += t.slice(u, e) + `
...
`);
        ...
        function Ms(a, t, e, s, i, r) {
          ...
          if (n === 123) {
            if (++t, { code: o, pos: t } = et(a, t, e, s, a.indexOf("}", t) - t, true, i, r), ++t, o !== null && o > 1114111)
              if (i)
                r.invalidCodePoint(t, e, s);
              else
                return { code: null, pos: t };
          } else
            ({ code: o, pos: t } = et(a, t, e, s, 4, false, i, r));
          return { code: o, pos: t };
        }
        function pe(a, t, e) {
        ...
        var br = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          ...
          readToken_numberSign() {
            ...
            if (e === 123 || e === 91 && this.hasPlugin("recordAndTuple")) {
              ...
              U(e) ? (++this.state.pos, this.finishToken(139, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(139, this.readWord1())) : this.finishOp(27, 1);
          }
          readToken_dot() {
          ...
          readRegexp() {
            ...
            for (; r < this.length; ) {
              ...
              if (br.has(h))
                h === 118 ? o.includes("u") && this.raise(p.IncompatibleRegExpUVFlags, l()) : h === 117 && o.includes("v") && this.raise(p.IncompatibleRegExpUVFlags, l()), o.includes(c) && this.raise(p.DuplicateRegExpFlags, l());
              else if (Z(h) || h === 92)
                this.raise(p.MalformedRegExpFlags, l());
              else
                break;
              ++r, o += c;
            }
        ...
        var Nr = (a) => class extends a {
          ...
          tsParseTupleElementType() {
            ...
            if (c === 58)
              r = true, o = false, n = this.parseIdentifier(true), this.expect(14), l = this.tsParseType();
            else if (c === 63) {
              o = true;
              ...
              l = this.tsParseType(), o = this.eat(17), r = this.eat(14);
            if (r) {
              let u;
          ...
          parseSubscript(e, s, i, r) {
            ...
            if (this.match(47) || this.match(51)) {
              let o, l = this.tsTryParseAndCatch(() => {
                ...
                if (c === 48 || c === 52 || c !== 10 && ue(c) && !this.hasPrecedingLineBreak())
                  return;
              ...
              if (o && this.unexpected(o, 10), l)
                return l.type === "TSInstantiationExpression" && ((this.match(16) || this.match(18) && this.lookaheadCharCode() !== 40) && this.raise(y.InvalidPropertyAccessAfterInstantiationExpression, this.state.startLoc), !this.match(16) && !this.match(18) && (l.expression = super.stopParseSubscript(e, r))), l;
            }
            return super.parseSubscript(e, s, i, r);
          }
          parseNewCallee(e) {
          ...
          parseVarStatement(e, s, i = false) {
            ...
            for (let { id: o, init: l } of n.declarations)
              l && (s === "var" || s === "let" || o.typeAnnotation ? this.raise(y.InitializerNotAllowedInAmbientContext, l) : vr(l, this.hasPlugin("estree")) || this.raise(y.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, l));
            return n;
          }
          ...
          parseMaybeAssign(e, s) {
            ...
            let h, c, u;
            if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
              if (h = this.state.clone(), c = this.tryParse(() => super.parseMaybeAssign(e, s), h), !c.error)
                return c.node;
            ...
            if (!c && (Ps(!this.hasPlugin("jsx")), u = this.tryParse(() => super.parseMaybeAssign(e, s), h), !u.error))
              return u.node;
            if ((r = c) != null && r.node)
          ...
          tsParseAbstractDeclaration(e, s) {
            ...
            if (this.isContextual(129)) {
              if (!this.hasFollowingLineBreak())
                return e.abstract = true, this.raise(y.NonClassMethodPropertyHasAbstractModifier, e), this.tsParseInterfaceDeclaration(e);
            } else
          ...
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            if (this.isContextual(93)) {
              ...
              if (this.isContextual(93)) {
                ...
                M(this.state.type) ? (c = false, l = s ? this.parseIdentifier() : this.parseModuleExportName()) : (h = true, o = d);
            } else
              M(this.state.type) && (h = true, s ? (o = this.parseIdentifier(true), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, true, true)) : o = this.parseModuleExportName());
        ...
        var Ts = F`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), Dr = (a) => class extends a {
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              let e = this.nextTokenStart();
              if (this.isUnparsedContextual(e, "from") && this.input.startsWith(H(133), this.nextTokenStartSince(e + 4)))
                return true;
            }
        ...
        function Or(a) {
          ...
          if (a.has("pipelineOperator")) {
            ...
            if (s === "hack") {
              ...
              {
                var e;
                if (i === "#" && ((e = a.get("recordAndTuple")) == null ? void 0 : e.syntaxType) === "hash")
            ...
            } else if (s === "smart" && ((t = a.get("recordAndTuple")) == null ? void 0 : t.syntaxType) === "hash")
        ...
        var _s = { estree: Ui, jsx: yr, flow: fr, typescript: Nr, v8intrinsic: Mr, placeholders: Dr }, Fr = Object.keys(_s), ht = class extends lt {
          ...
          parseMaybeAssign(t, e) {
            ...
            if (i) {
              ...
              if ((this.hasPlugin("v8intrinsic") ? ue(l) : ue(l) && !this.match(54)) && !this.isAmbiguousPrefixOrIdentifier())
          ...
          parseExprOp(t, e, s) {
            ...
            if (Ki(i) && (this.prodParam.hasIn || !this.match(58))) {
              ...
              if (r > s) {
                ...
                if (l && (r = Ce(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
...
`), cooked: r === null ? null : r.slice(1, h) }, o.tail = l, this.next();
          ...
          parseObjectProperty(t, e, s, i) {
            if (t.shorthand = false, this.eat(14))
              return t.value = s ? this.parseMaybeDefault(this.state.startLoc) : this.parseMaybeAssignAllowIn(i), this.finishObjectProperty(t);
        ...
        var ct = class extends ht {
          ...
          parseClassMemberWithIsStatic(t, e, s, i) {
            ...
            if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
              ...
              this.isLineTerminator() ? A ? this.pushClassPrivateProperty(t, l) : this.pushClassProperty(t, o) : this.unexpected();
          }
          ...
          shouldParseExportDeclaration() {
            ...
            if (t === 26 && (this.expectOnePlugin(["decorators", "decorators-legacy"]), this.hasPlugin("decorators")))
              return this.getPluginOption("decorators", "decoratorsBeforeExport") === true && this.raise(p.DecoratorBeforeExport, this.state.startLoc), true;
            if (this.hasPlugin("explicitResourceManagement")) {
              if (this.isUsing())
                return this.raise(p.UsingDeclarationExport, this.state.startLoc), true;
              if (this.isAwaitUsing())
                return this.raise(p.UsingDeclarationExport, this.state.startLoc), true;
            }
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
      ...
      function Wr(a, t) {
        let e = null, s = t;
        for (; s !== e; )
          e = s, s = Us(a, s), s = $s(a, s), s = qs(a, s), s = Vs(a, s);
        return s;
      }
      var zs = Wr;
      function Jr(a) {
...
`);
      ...
      function na(a) {
        ...
        for (let e = a.length - 1; e >= 0; e--) {
          let s = a[e];
          if (t && k(s) === v(t) && Et(s) && Et(t) && (a.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [v(s), k(t)]), !bt(s) && !G(s))
        ...
        a = ei(a, (l) => {
          switch (l.type) {
            case "ParenthesizedExpression": {
              ...
              if (!u)
                return h.extra = { ...h.extra, parenthesized: true }, h;
              break;
            }
...
`;
      ...
      function di(a) {
        if (typeof a == "string") {
          if (a = a.toLowerCase(), /\.(?:mjs|mts)$/iu.test(a))
            return Nt;
          if (/\.(?:cjs|cts)$/iu.test(a))
            return kt;
        }
      }
      function Aa(a, t) {
      ...
      function Ia({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          let { filepath: i } = s;
          if (typeof i != "string" && (i = void 0), (s.parser === "babel" || s.parser === "__babel_estree") && Ca(e, i))
